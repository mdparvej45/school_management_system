                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            ...
                                            <p class="text-muted">Get your <b>Atharabari M.C. School</b> Management Teacher ID</p>
                                        </div>

                                        <div class="mt-4">
                                            <form class="needs-validation" method="PUT" novalidate action="{{ route('register') }}">
                                                @csrf
                                                <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0">&copy;
                                <script>document.write(new Date().getFullYear())</script> Developed by <a href="https://saibonsoft.com/" >Saibon Soft</a>
                            </p>
                        </div>
                    </div>
                </div>
